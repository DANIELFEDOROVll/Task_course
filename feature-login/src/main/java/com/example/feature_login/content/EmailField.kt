    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        TextField(
            ...
            colors = TextFieldDefaults.textFieldColors(
                containerColor = LightGray, // Цвет фона
                cursorColor = Color.White, // Цвет курсора
                focusedIndicatorColor = Color.Transparent, // Прозрачная рамка при фокусе
                unfocusedIndicatorColor = Color.Transparent, // Прозрачная рамка без фокуса
                disabledIndicatorColor = Color.Transparent // Прозрачная рамка в отключенном состоянии
            )
        )
    }
}